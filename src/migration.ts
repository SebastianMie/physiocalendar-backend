...
const jsonData = JSON.parse(fs.readFileSync(path.resolve(__dirname, '../data/backup.json'), 'utf8'));
...
async function migrateData(data: { therapists: any[]; appointments: any[]; appointmentseries: any[]; }, runner: any) {
